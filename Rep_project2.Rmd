---
title: Exploring Severe Weather Events' Impacts on Public Health and Economy across
  the United States
author: "Xinyu W"
output:
...
```{r groupTypes, echo=TRUE, cache=TRUE}
